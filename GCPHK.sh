S=v4 OPTIMIZE=1 bash <(curl -fLSs https://dl.nyafw.com/download/nyanpass-install.sh) rel_nodeclient "-o -t a95ad1f2-5d58-48b2-8dbf-c628f59dbca3 -u https://ny.188002.xyz"
...
S=null bash <(curl -fLSs https://dl.nyafw.com/download/nyanpass-install.sh) rel_nodeclient "-o -t 1fa0194c-48e6-4970-87fd-6e0ee6bc345c -u https://ny.papawall.cc"
